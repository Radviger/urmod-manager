 ...
 *
 */
public class CarTreePanel extends JScrollPane implements ActionListener {
	...
	private DefaultMutableTreeNode createRootNodes(CarVO mod) {
		...
		if (!modFolder.exists() || !modFolder.isDirectory()) {
			return new DefaultMutableTreeNode("車輛Mod目錄不存在");
		}
	...
	class TreeCellRenderer extends DefaultTreeCellRenderer {
		...
		private boolean isMatch(File modFile, File gameFile) {
			String modDir = Utils.prop.getProperty(Constant.MOD_DIR) + File.separator + Constant.CARS_FOLDER + File.separator + mod.getName() + File.separator;
			...
			String gameDir = Utils.prop.getProperty(Constant.GAME_DIR) + File.separator + Constant.CARS_MOD_GAMEDIR;
