 ...
 *
 */
public class GameTreePanel extends JScrollPane implements ActionListener {
	...
	private ModVO mod;
	private JTree tree;
	private ModDetailFrame detailFrame;
	
	public GameTreePanel(ModVO mod, ModDetailFrame detailFrame) {
		super();
		this.mod = mod;
