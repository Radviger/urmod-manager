 ...
 * 編輯Mod內容視窗
 */
public class ModEditFrame extends JFrame implements ActionListener {
	...
	public ModEditFrame(ModVO mod, JTable modTable) {
		super();
		...
		this.setTitle("編輯Mod內容");
		this.setIconImage(ModIcon.MOD_EDIT.getImage());
	...
	public void actionPerformed(ActionEvent e) {
		...
		case MENU_OK:
			...
			//修改Mod目錄名稱
			File modDir = new File(Utils.getModDir(mod));
			if (modDir.renameTo(new File(Utils.getModDir(), nameTextField.getText()))) {
